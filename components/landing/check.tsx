  ...
  return(
    <div className='w-full h-full min-h-screen'>
      ...
      <div className='w-full h-full relative grid'>
        <img src="/hero2.png" alt="" className='w-full h-full absolute top-0 left-0 object-cover'/>            
      ...
      <div className='w-full relative shadow-custom'>
        <div className='w-full max-w-6 absolute right-0 grid grid-col-4'>
          <ReviewCard/>
          <ReviewCard/>
          <ReviewCard/>
          <ReviewCard/>
